...
INSERT INTO `menu` VALUES
  (1, 'CUSTOMER_MANAGEMENT', '客户管理', NULL, NULL, NULL, NULL, 1),
  (2, 'MY_CUSTOMER', '我的客户', NULL, 1, NULL, NULL, 1),
  (3, 'DEPARTMENT_OPEN_SEA', '部门公海', NULL, 1, 1, NULL, 1),
  (4, 'COMPANY_OPEN_SEA', '公司公海', NULL, 1, 2, NULL, 1),
  (5, 'PRODUCTION_MANAGEMENT', '产品管理', NULL, NULL, NULL, NULL, 1),
  (6, 'CONTRACT_MANAGEMENT', '合同管理', NULL, NULL, NULL, NULL, 1),
  (7, 'MY_CONTRACT', '我的合同', NULL, 6, NULL, NULL, 1),
  (8, 'DEPARTMENT_CONTRACT', '部门合同', NULL, 6, 28, NULL, 1),
  (9, 'COMPANY_CONTRACT', '公司合同', NULL, 6, 29, NULL, 1),
  (10, 'USER_MANAGEMENT', '员工管理', NULL, NULL, NULL, NULL, 1),
  (11, 'DEPARTMENT_USER', '部门员工', NULL, 10, NULL, NULL, 1),
  (12, 'COMPANY_USER', '公司员工', NULL, 10, NULL, NULL, 1),
  (13, 'ROLE_AND_PERMISSION', '角色与权限', NULL, NULL, NULL, NULL, 1),
  (14, 'MY_ROLE_AND_PERMISSION', '我的', NULL, 13, NULL, NULL, 1),
  (15, 'ROLES', '角色', NULL, 13, NULL, NULL, 1),
  (16, 'PERSONAL_CENTER', '个人中心', NULL, NULL, NULL, NULL, 1),
  (17, 'NOTIFICATION_CENTER', '通知中心', NULL, NULL, NULL, NULL, 1),
  (18, 'SYSTEM_NOTIFICATION', '系统通知', NULL, 17, NULL, NULL, 1),
  (19, 'USER_NOTIFICATION', '站内信', NULL, 17, NULL, NULL, 0),
  (20, 'SETTING', '设置', NULL, NULL, NULL, NULL, 1),
  (21, 'MY_SETTING', '个人设置', NULL, 20, NULL, NULL, 1),
  (22, 'SYSTEM_SETTING', '系统配置', NULL, 20, 35, NULL, 1);
/*!40000 ALTER TABLE `menu`
  ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `permission` VALUES
  (1, 1, 'CUSTOMER_DEPARTMENT_VIEW', 'customer:department:view', '查看部门公海', NULL, NULL, -1, NOW(), NULL, NULL, NULL,
   NULL),
  (2, 1, 'CUSTOMER_COMPANY_VIEW', 'customer:company:view', '查看公司公海', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (3, 1, 'CUSTOMER_ADD', 'customer:add', '添加客户', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (4, 1, 'CUSTOMER_MY_UPDATE', 'customer:my:update', '修改我的客户', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (5, 1, 'CUSTOMER_DEPARTMENT_UPDATE', 'customer:department:update', '修改部门客户', NULL, 1, -1, NOW(), NULL, NULL, NULL, NULL),
  (6, 1, 'CUSTOMER_COMPANY_UPDATE', 'customer:company:update', '修改公司客户', NULL, 2, -1, NOW(), NULL, NULL, NULL, NULL),
  (7, 1, 'CUSTOMER_COMMUNICATION_ADD', 'customer:communication:add', '添加拜访记录', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (8, 1, 'CUSTOMER_STATUS_CHANGE', 'customer:status:change', '状态转换', '用于客户状态之间的转换（如新客户转换到意向客户）', NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (9, 1, 'CUSTOMER_MY_DELETE', 'customer:my:delete', '删除我的客户', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (10, 1, 'CUSTOMER_DEPARTMENT_DELETE', 'customer:department:delete', '删除部门客户', NULL, 1, -1, NOW(), NULL, NULL, NULL, NULL),
  (11, 1, 'CUSTOMER_COMPANY_DELETE', 'customer:company:delete', '删除公司客户', NULL, 2, -1, NOW(), NULL, NULL, NULL, NULL),
  (12, 1, 'CUSTOMER_DEPARTMENT_TRANSFER_TO_USER', 'customer:department:transfer_to_user', '转入到员工', '从部门公海中将客户转移至部门内部员工', 1, -1, NOW(), NULL, NULL, NULL, NULL),
  (13, 1, 'CUSTOMER_MY_TRANSFER_TO_USER', 'customer:my:transfer_to_user', '转出到员工', '将其客户转移至部门内部员工', NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (14, 1, 'CUSTOMER_COMPANY_TRANSFER_TO_DEPARTMENT', 'customer:company:transfer_to_department', '转入到部门', '将公司公海中的客户转移至员工所属的部门', 2, -1, NOW(), NULL, NULL, NULL, NULL),
  (15, 1, 'CUSTOMER_MY_TRANSFER_TO_DEPARTMENT', 'customer:my:transfer_to_department', '转出到部门', '将其客户转移至部门公海', NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (16, 1, 'CUSTOMER_APPROVAL', 'customer:approval', '审批客户', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (17, 2, 'USER_DEPARTMENT_VIEW', 'user:department:view', '查看部门员工', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (18, 2, 'USER_COMPANY_VIEW', 'user:company:view', '查看公司员工', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (19, 2, 'USER_ADD', 'user:add', '添加员工', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (20, 2, 'USER_UPDATE', 'user:update', '修改员工', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (21, 2, 'USER_DELETE', 'user:delete', '员工离职', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (22, 3, 'ROLE_ADD', 'role:add', '添加角色', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (23, 3, 'ROLE_UPDATE', 'role:update', '修改角色', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (24, 3, 'ROLE_DELETE', 'role:delete', '删除角色', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (25, 4, 'DEPARTMENT_ADD', 'department:add', '添加部门', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (26, 4, 'DEPARTMENT_UPDATE', 'department:update', '修改部门', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (27, 4, 'DEPARTMENT_DELETE', 'department:delete', '删除部门', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (28, 5, 'CONTRACT_DEPARTMENT_VIEW', 'contract:department:view', '查看部门合同', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (29, 5, 'CONTRACT_COMPANY_VIEW', 'contract:company:view', '查看公司合同', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (30, 5, 'CONTRACT_UPDATE', 'contract:update', '修改合同', '只能修改未生效的合同', NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (31, 5, 'CONTRACT_APPROVAL', 'contract:approval', '审批合同', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (32, 6, 'PRODUCTION_ADD', 'production:add', '添加产品', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (33, 6, 'PRODUCTION_UPDATE', 'production:update', '修改产品', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (34, 6, 'PRODUCTION_DELETE', 'production:delete', '删除产品', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (35, 7, 'SYSTEM_CONFIGURE', 'system:configure', '系统配置', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (36, 8, 'DEPARTMENT_GOAL_VIEW', 'department_goal:view', '查看部门目标', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (37, 8, 'DEPARTMENT_GOAL_ASSIGN', 'department_goal:assign', '分配部门目标', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (38, 8, 'USER_GOAL_VIEW', 'user_goal:view', '查看员工目标', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (39, 8, 'USER_GOAL_ASSIGN', 'user_goal:assign', '分配员工目标', NULL, 37, -1, NOW(), NULL, NULL, NULL, NULL);
