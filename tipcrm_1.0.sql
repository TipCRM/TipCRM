...
INSERT INTO `permission` VALUES
  (1, 'CUSTOMER_DEPARTMENT_VIEW', 'customer:department:view', '查看部门公海', NULL, NULL, -1, NOW(), NULL, NULL, NULL,
   NULL),
  (2, 'CUSTOMER_COMPANY_VIEW', 'customer:company:view', '查看公司公海', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (3, 'CUSTOMER_ADD', 'customer:add', '添加客户', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (4, 'CUSTOMER_MY_UPDATE', 'customer:my:update', '修改我的客户', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (5, 'CUSTOMER_DEPARTMENT_UPDATE', 'customer:department:update', '修改部门客户', NULL, 1, -1, NOW(), NULL, NULL, NULL, NULL),
  (6, 'CUSTOMER_COMPANY_UPDATE', 'customer:company:update', '修改公司客户', NULL, 2, -1, NOW(), NULL, NULL, NULL, NULL),
  (7, 'CUSTOMER_COMMUNICATION_ADD', 'customer:communication:add', '添加拜访记录', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (8, 'CUSTOMER_STATUS_CHANGE', 'customer:status:change', '状态转换', '用于客户状态之间的转换（如新客户转换到意向客户）', NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (9, 'CUSTOMER_MY_DELETE', 'customer:my:delete', '删除我的客户', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (10, 'CUSTOMER_DEPARTMENT_DELETE', 'customer:department:delete', '删除部门客户', NULL, 1, -1, NOW(), NULL, NULL, NULL, NULL),
  (11, 'CUSTOMER_COMPANY_DELETE', 'customer:company:delete', '删除公司客户', NULL, 2, -1, NOW(), NULL, NULL, NULL, NULL),
  (12, 'CUSTOMER_DEPARTMENT_TRANSFER_TO_USER', 'customer:department:transfer_to_user', '转入到员工', '从部门公海中将客户转移至部门内部员工', 1, -1, NOW(), NULL, NULL, NULL, NULL),
  (13, 'CUSTOMER_MY_TRANSFER_TO_USER', 'customer:my:transfer_to_user', '转出到员工', '将其客户转移至部门内部员工', NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (14, 'CUSTOMER_COMPANY_TRANSFER_TO_DEPARTMENT', 'customer:company:transfer_to_department', '转入到部门', '将公司公海中的客户转移至员工所属的部门', 2, -1, NOW(), NULL, NULL, NULL, NULL),
  (15, 'CUSTOMER_MY_TRANSFER_TO_DEPARTMENT', 'customer:my:transfer_to_department', '转出到部门', '将其客户转移至部门公海', NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (16, 'CUSTOMER_APPROVAL', 'customer:approval', '审批客户', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (17, 'USER_DEPARTMENT_VIEW', 'user:department:view', '查看部门员工', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (18, 'USER_COMPANY_VIEW', 'user:company:view', '查看公司员工', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (19, 'USER_ADD', 'user:add', '添加员工', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (20, 'USER_UPDATE', 'user:update', '修改员工', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (21, 'USER_DELETE', 'user:delete', '员工离职', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (22, 'ROLE_ADD', 'role:add', '添加角色', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (23, 'ROLE_UPDATE', 'role:update', '修改角色', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (24, 'ROLE_DELETE', 'role:delete', '删除角色', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (25, 'DEPARTMENT_ADD', 'department:add', '添加部门', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (26, 'DEPARTMENT_UPDATE', 'department:update', '修改部门', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (27, 'DEPARTMENT_DELETE', 'department:delete', '删除部门', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (28, 'CONTRACT_DEPARTMENT_VIEW', 'contract:department:view', '查看部门合同', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (29, 'CONTRACT_COMPANY_VIEW', 'contract:company:view', '查看公司合同', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (30, 'CONTRACT_APPROVAL', 'contract:approval', '审批合同', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (31, 'PRODUCTION_ADD', 'production:add', '添加产品', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (32, 'PRODUCTION_UPDATE', 'production:update', '修改产品', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (33, 'PRODUCTION_DELETE', 'production:delete', '删除产品', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (34, 'SYSTEM_CONFIGURE', 'system:configure', '系统配置', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (35, 'DEPARTMENT_GOAL_VIEW', 'department_goal:view', '查看部门目标', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (36, 'DEPARTMENT_GOAL_ASSIGN', 'department_goal:assign', '分配部门目标', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (37, 'USER_GOAL_VIEW', 'user_goal:view', '查看员工目标', NULL, NULL, -1, NOW(), NULL, NULL, NULL, NULL),
  (38, 'USER_GOAL_ASSIGN', 'user_goal:assign', '分配员工目标', NULL, 37, -1, NOW(), NULL, NULL, NULL, NULL);
