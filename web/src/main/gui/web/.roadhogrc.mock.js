...
const apis = {
  ...
  'GET /public/api/menu' : {status: 200, data:[
    {title:'客户管理',name:'CUSTOMER',children:[
      {title:'我的所有客户', id: 1, name: 'MY_CUSTOMER',
        children:[
          {title:'客户资料', name:'CUSTOMER_INFO', id:1 },
    ...
    {title:'通知中心',name:'NOTIFICATION', children:[
      {title: '客户操作通知', id:1, name: 'CUSTOMER_NOTIFICATION'},
